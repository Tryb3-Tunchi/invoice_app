...
import {
  generateId, addDays, calcTotal,
  validateInvoice, EMPTY_INVOICE, formatCurrency
} from '../utils/Invoice'
...
export default function InvoiceForm({ invoiceId, onClose }) {
  ...
  const [form, setForm] = useState(() =>
    existing ? { ...existing, items: existing.items.map(i => ({ ...i })) }
             : { ...EMPTY_INVOICE, items: [] }
  )
  ...
  const E = ({ field }) => errors[field]
    ? <span className={styles.errMsg} role="alert">{errors[field]}</span>
    : null
      ...
      <div className={styles.drawer}>
        <div className={styles.drawerInner}>
          <h2 className={styles.heading}>
            {isEdit ? <>Edit <span className={styles.hash}>#</span>{existing.id}</> : 'New Invoice'}
          </h2>
          ...
          <div className={styles.form}>
            ...
            <fieldset className={styles.fieldset}>
              ...
              <div className={styles.formGroup} data-error={!!errors.senderStreet}>
                <label htmlFor="senderStreet" className={styles.label}>Street Address</label>
                <input
                  ref={firstInputRef}
                  id="senderStreet"
              ...
              <div className={styles.row3}>
                <div className={styles.formGroup} data-error={!!errors.senderCity}>
                ...
                <div className={styles.formGroup} data-error={!!errors.senderPostCode}>
                  <label htmlFor="senderPostCode" className={styles.label}>Post Code</label>
                  <input
                    id="senderPostCode"
                ...
                <div className={styles.formGroup} data-error={!!errors.senderCountry}>
                  <label htmlFor="senderCountry" className={styles.label}>Country</label>
                  <input
                    id="senderCountry"
            ...
            <fieldset className={styles.fieldset}>
              ...
              <div className={styles.formGroup} data-error={!!errors.clientName}>
                <label htmlFor="clientName" className={styles.label}>Client's Name</label>
                <input
                  id="clientName"
              ...
              <div className={styles.formGroup} data-error={!!errors.clientEmail}>
                <label htmlFor="clientEmail" className={styles.label}>Client's Email</label>
                <input
                  id="clientEmail"
                  type="email"
              ...
              <div className={styles.formGroup} data-error={!!errors.clientStreet}>
                <label htmlFor="clientStreet" className={styles.label}>Street Address</label>
                <input
                  id="clientStreet"
              ...
              <div className={styles.row3}>
                <div className={styles.formGroup} data-error={!!errors.clientCity}>
                  <label htmlFor="clientCity" className={styles.label}>City</label>
                  <input
                    id="clientCity"
                ...
                <div className={styles.formGroup} data-error={!!errors.clientPostCode}>
                  <label htmlFor="clientPostCode" className={styles.label}>Post Code</label>
                  <input
                    id="clientPostCode"
                ...
                <div className={styles.formGroup} data-error={!!errors.clientCountry}>
                  <label htmlFor="clientCountry" className={styles.label}>Country</label>
                  <input
                    id="clientCountry"
            ...
            <fieldset className={styles.fieldset}>
              ...
              <div className={styles.row2}>
                <div className={styles.formGroup} data-error={!!errors.createdAt}>
                  <label htmlFor="createdAt" className={styles.label}>Invoice Date</label>
                  <input
                    id="createdAt"
                    type="date"
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="paymentTerms" className={styles.label}>Payment Terms</label>
                  <select
                    id="paymentTerms"
              ...
              <div className={styles.formGroup} data-error={!!errors.description}>
            ...
            <fieldset className={styles.fieldset}>
              ...
              <div className={styles.itemsList}>
                {form.items.map((item, i) => (
                  <div key={i} className={styles.itemRow}>
                    <div className={styles.formGroup} data-error={!!errors[`item_${i}_name`]}>
                      <label htmlFor={`item_name_${i}`} className={`${styles.label} ${styles.mobileLabel}`}>Item Name</label>
                      <input
                        id={`item_name_${i}`}
                    ...
                    <div className={styles.formGroup} data-error={!!errors[`item_${i}_qty`]}>
                      <label htmlFor={`item_qty_${i}`} className={`${styles.label} ${styles.mobileLabel}`}>Qty.</label>
                      <input
                        id={`item_qty_${i}`}
                        type="number"
                        min="1"
                    ...
                    <div className={styles.formGroup} data-error={!!errors[`item_${i}_price`]}>
                      <label htmlFor={`item_price_${i}`} className={`${styles.label} ${styles.mobileLabel}`}>Price</label>
                      <input
                        id={`item_price_${i}`}
                        type="number"
                        min="0"
                    ...
                    <div className={styles.itemTotal}>
                      <span className={`${styles.label} ${styles.mobileLabel}`}>Total</span>
              ...
              {errors.items && (
                <p className={styles.errMsg} role="alert" style={{marginTop: '8px'}}>{errors.items}</p>
              )}
